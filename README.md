...
[![GoDoc](https://godoc.org/github.com/adl-golang/quicktemplate?status.svg)](http://godoc.org/github.com/adl-golang/quicktemplate)
[![Go Report Card](https://goreportcard.com/badge/github.com/adl-golang/quicktemplate)](https://goreportcard.com/report/github.com/adl-golang/quicktemplate)
...
# Features
  ...
  * Easy to use. See [quickstart](#quick-start) and [examples](https://github.com/adl-golang/quicktemplate/tree/master/examples)
    for details.
  ...
  * Easy to use template inheritance powered by [Go interfaces](https://golang.org/doc/effective_go.html#interfaces).
    See [this example](https://github.com/adl-golang/quicktemplate/tree/master/examples/basicserver) for details.
...
The following simple template is used in the benchmark:
  ...
  * [html/template version](https://github.com/adl-golang/quicktemplate/blob/master/testdata/templates/bench.tpl)
  * [quicktemplate version](https://github.com/adl-golang/quicktemplate/blob/master/testdata/templates/bench.qtpl)

Benchmark results:

```
$ go test -bench='Benchmark(Quick|HTML)Template' -benchmem github.com/adl-golang/quicktemplate/tests
...
See [examples](https://github.com/adl-golang/quicktemplate/tree/master/examples).

# Quick start

First of all, install the `quicktemplate` package
and [quicktemplate compiler](https://github.com/adl-golang/quicktemplate/tree/master/qtc) (`qtc`):

```
go get -u github.com/adl-golang/quicktemplate
...
There are other useful tags supported by quicktemplate:
  ...
  * `{% interface %}`:
    ...
    See [basicserver example](https://github.com/adl-golang/quicktemplate/tree/master/examples/basicserver)
    for more details.
...
```
go test -bench=Marshal -benchmem github.com/adl-golang/quicktemplate/tests
  ...
  * *What's the difference between quicktemplate and [ego](https://github.com/benbjohnson/ego)?*
    ...
    and easy to use:
      ...
      * Template interfaces, inheritance and overriding.
        See [this example](https://github.com/adl-golang/quicktemplate/tree/master/examples/basicserver)
        for details.
...
* *Is there a syntax highlighting for qtpl files?*
  ...
  Yes - see [this issue](https://github.com/adl-golang/quicktemplate/issues/19) for details.
...
* *I didn't find an answer for my question here.*
  ...
  Try exploring [these questions](https://github.com/adl-golang/quicktemplate/issues?q=label%3Aquestion).
